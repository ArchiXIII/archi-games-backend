...
- рейтинг звёзд с пагинацией и текущим результатом пользователя; точное место возвращается только внутри запрошенного топа;
...
- кэширование планов YQL и общий для пользователей шестичасовой кэш топов рейтингов;
...
- `leaderboard_totals` — итоговые звёзды по игре, платформе и пользователю; индекс покрывает только отображаемое имя;
...
1. Применить миграции 001–005 к `archi-games-db`; миграции 004–005 сокращают индексы рейтингов.
