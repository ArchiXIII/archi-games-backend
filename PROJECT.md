...
- callback Direct Games для VK `get_item`, grant и refund с проверкой подписи;
- отдельный callback покупок Жора в OK с проверкой подписи, публичного ключа, товара и цены;
