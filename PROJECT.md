...
- ограниченные таймауты и повторы YDB-запросов, уменьшенный пул сессий, короткие кэши повторных запросов и сокращённые запросы места игрока для защиты serverless-функции от перегрузки;
